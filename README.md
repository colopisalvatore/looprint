...
The core logic is based on Factorian Designs' G-code automation concept.

👉 **It is highly recommended to watch his video to fully understand the underlying idea and safety considerations.**
...
If you run into issues or want to better understand the automation concept, watch the Factorian Designs video that this system is based on. It explains the mechanics and safety considerations in detail.
